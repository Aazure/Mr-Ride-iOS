...
extension UIColor {
    ...
    class func mrBluishColor() -> UIColor {
        return UIColor(red: 36.0 / 255.0, green: 118.0 / 255.0, blue: 219.0 / 255.0, alpha: 1.0)
    }
    
    class func mrWhite70Color() -> UIColor {
        return UIColor(white: 255.0 / 255.0, alpha: 0.7)
    }
    ...
    class func mrDarkSlateBlue90Color() -> UIColor {
        return UIColor(red: 14.0 / 255.0, green: 52.0 / 255.0, blue: 64.0 / 255.0, alpha: 0.9)
    }
    
    class func mrBrightBlueColor() -> UIColor {
        return UIColor(red: 0.0, green: 122.0 / 255.0, blue: 255.0 / 255.0, alpha: 1.0)
    }
    
    class func mrWhiteTwoColor() -> UIColor {
        return UIColor(white: 249.0 / 255.0, alpha: 1.0)
    }
    
    class func mrPinkishGreyTwoColor() -> UIColor {
        return UIColor(white: 205.0 / 255.0, alpha: 1.0)
    }
    
    class func mrBlack50Color() -> UIColor {
